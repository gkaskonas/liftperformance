...
export default function Subscribe() {
  ...
  const subscribe = async (e: any) => {
    ...
    try {
      ...
      const error = "Subscription failed. Please try again later or you are already subscribed!";
          ...
          <div className="grid items-center gap-x-6 lg:grid-cols-2">
            <div className="mb-10 lg:mb-0">
              <h2 className="dark: text-center text-2xl  font-bold sm:text-3xl">
                ...
                <br />
                <span className="text-red-700">Subscribe to the newsletter</span>
              </h2>
            </div>

            <div className="mb-6 sm:mx-auto sm:w-1/2 md:mb-0 lg:w-full 2xl:w-4/5" onSubmit={subscribe}>
              ...
              {state === "Success" && <div className="">Awesome, you've been subscribed!</div>}
            </div>
          </div>
        </div>
      </div>
