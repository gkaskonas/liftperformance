          ...
          <div className="flex grid items-center md:grid-cols-2">
            <div className="mb-12 lg:mb-0">
              <div className="relative z-[1] block rounded-lg bg-[hsla(0,0%,100%,0.55)] px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] backdrop-blur-[30px] dark:bg-[hsla(0,0%,5%,0.55)] dark:shadow-black/20 md:px-12 lg:-mr-14">
                <h2 className="mb-8 text-3xl font-bold">Why               <span className="bg-gradient-to-r from-red-600 to-yellow-500  bg-clip-text font-extrabold text-transparent">
                LIFT
              </span>{""}?</h2>
                <p className="mb-8 pb-2 text-neutral-500 dark:text-neutral-300 lg:pb-0 tracking-tighter lg:text-xl">
                ...
                <p className="mb-0 text-neutral-500 dark:text-neutral-300 tracking-tight lg:text-xl">
