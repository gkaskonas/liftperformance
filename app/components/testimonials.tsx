                  ...
                  <div
                    ...
                    <div className="flex flex-wrap items-center">
                      <div className="block w-full  basis-auto lg:flex lg:w-6/12 xl:w-4/12">
                        <Image src={bradley_testimonial} alt="Bradley Testimonial" placeholder={"blur"} width={1024}
              ...
              <div
                ...
                <section className="mb-10 text-center md:text-left">
                  <div
                    ...
                    <div className="flex flex-wrap items-center">
                      <div className="block w-full  basis-auto lg:flex lg:w-6/12 xl:w-4/12">
                        <Image src={clara_testimonial} alt="Bradley Testimonial" placeholder={"blur"} width={1024}
                          className="w-full rounded-t-lg lg:rounded-tr-none lg:rounded-bl-lg" />
                      </div>
                      <div className="w-full shrink-0 grow-0 basis-auto lg:w-6/12 xl:w-8/12">
                        <div className="mt-5 md:px-12">
              ...
              <div
                ...
                <section className="mb-10 text-center md:text-left">
                  <div
                    ...
                    <div className="flex flex-wrap items-center">
                      <div className="block w-full  basis-auto lg:flex lg:w-6/12 xl:w-4/12">
                        <Image src={kochun_testimonial} alt="Bradley Testimonial" placeholder={"blur"} width={1024}
                          className="w-full rounded-t-lg lg:rounded-tr-none lg:rounded-bl-lg" />
                      </div>
                      <div className="w-full shrink-0 grow-0 basis-auto lg:w-6/12 xl:w-8/12">
                  ...
                  <div
                    ...
                    <div className="flex flex-wrap items-center">
                      <div className="block w-full shrink-0 grow-0 basis-auto lg:flex lg:w-6/12 xl:w-4/12">
                        <Image src={attiya_testimonial} alt="Bradley Testimonial" placeholder={"blur"} width={1024}
                          className="w-full rounded-t-lg lg:rounded-tr-none lg:rounded-bl-lg" />
                      </div>
                      <div className="w-full shrink-0 grow-0 basis-auto lg:w-6/12 xl:w-8/12">
                        <div className="mt-5 md:px-12">
              ...
              <div
                ...
                <section className="mb-10 text-center md:text-left">
                  <div
                    ...
                    <div className="flex flex-wrap items-center">
                      <div className="block w-full shrink-0 grow-0 basis-auto lg:flex lg:w-6/12 xl:w-4/12">
                        <Image src={christopher_testimonial} alt="Bradley Testimonial" placeholder={"blur"} width={1024}
                          className="w-full rounded-t-lg lg:rounded-tr-none lg:rounded-bl-lg" />
                      </div>
                      <div className="w-full shrink-0 grow-0 basis-auto lg:w-6/12 xl:w-8/12">
                        <div className="mt-5 md:px-12">
              ...
              <div
                ...
                <section className="mb-10 text-center md:text-left">
                  <div
                    ...
                    <div className="flex flex-wrap items-center">
                      <div className="block w-full shrink-0 grow-0 basis-auto lg:flex lg:w-6/12 xl:w-4/12">
                        <Image src={simon_clipped} alt="Bradley Testimonial" placeholder={"blur"} width={1024}
                          className="w-full rounded-t-lg lg:rounded-tr-none lg:rounded-bl-lg" />
                      </div>
                      <div className="w-full shrink-0 grow-0 basis-auto lg:w-6/12 xl:w-8/12">
                        <div className="mt-5 md:px-12">
              ...
              <div
                ...
                <section className="mb-10 text-center md:text-left">
                  <div
                    ...
                    <div className="flex flex-wrap items-center">
                      <div className="block w-full shrink-0 grow-0 basis-auto lg:flex lg:w-6/12 xl:w-4/12">
                        <Image src={jon_clipped} alt="Bradley Testimonial" placeholder={"blur"} width={1024}
                          className="w-full rounded-t-lg lg:rounded-tr-none lg:rounded-bl-lg" />
                      </div>
                      <div className="w-full shrink-0 grow-0 basis-auto lg:w-6/12 xl:w-8/12">
                        <div className="mt-5 md:px-12">
              ...
              <div
                ...
                <section className="mb-10 text-center md:text-left">
                  <div
                    ...
                    <div className="flex flex-wrap items-center">
                      <div className="block w-full shrink-0 grow-0 basis-auto lg:flex lg:w-6/12 xl:w-4/12">
                        <Image src={chen_clipped} alt="Bradley Testimonial" placeholder={"blur"} width={1024}
                          className="w-full rounded-t-lg lg:rounded-tr-none lg:rounded-bl-lg" />
                      </div>
                      <div className="w-full shrink-0 grow-0 basis-auto lg:w-6/12 xl:w-8/12">
                        <div className="mt-5 md:px-12">
