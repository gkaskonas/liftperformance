                ...
                <section className="mb-10 text-center md:text-left">
                  <div className="block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] xl:w-3/4 xl:items-center xl:justify-center xl:mx-auto">
                    <div className="flex flex-wrap items-center">
                      ...
                      <div className="w-full shrink-0 grow-0 basis-auto sm:w-6/12 xl:w-8/12">
                        <div className="mt-5 md:px-12">
                          <h2 className="mb-2 text-3xl font-bold text-red-700">Clara</h2>
                          <p className="mb-6 text-black text-lg sm:text-xl">
                            “Dennis is an incredible trainer who is very passionate about his clients and programs. His
                            encouragement and constant motivation push me to heights I never thought possible. I find
                            myself always looking forward to his next session”
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-wrap items-center">
                      ...
                      <div className="w-full shrink-0 grow-0 basis-auto sm:w-6/12 xl:w-8/12">
                        <div className="mt-6 md:px-12">
                          <h2 className="mb-2 text-3xl font-bold text-red-700">Ko Chun</h2>
                          <p className="mb-20 text-black text-lg sm:text-xl">
                            “Every session with Dennis is a guaranteed good work out - I have definitely noticed an
                            improved physique and strength over time!”
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <section className="mb-10 text-center md:text-left">
                  <div className="block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] xl:w-3/4 xl:items-center xl:justify-center xl:mx-auto">
                    <div className="flex flex-wrap items-center">
                      ...
                      <div className="w-full shrink-0 grow-0 basis-auto sm:w-6/12 xl:w-8/12">
                        <div className="mt-5 md:px-12">
                          <h2 className="mb-2 text-3xl font-bold text-red-700">Attiya</h2>
                          <p className="mb-6 text-black text-lg sm:text-xl">
                            “After training with Eunice, I have tried a lot more new exercises, ones i wouldn’t have
                            tried or done by myself if it wasn’t for her. I wouldn’t have the discipline to achieve my
                            goals.”
                          </p>
                        </div>
                      </div>
                ...
                <section className="mb-10 text-center md:text-left">
                  <div className="block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] xl:w-3/4 xl:items-center xl:justify-center xl:mx-auto">
                    <div className="flex flex-wrap items-center">
                      ...
                      <div className="w-full shrink-0 grow-0 basis-auto sm:w-6/12 xl:w-8/12">
                        <div className="mt-5 md:px-12">
                          <h2 className="mb-2 text-3xl font-bold text-red-700">Simon</h2>
                          <p className="mb-6 text-black text-lg sm:text-xl">
                            “Having a PT helps me attend the gym regularly, and the variety of exercises and careful
                            building of strength and flexibility have worked really well for me.”
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <section className="mb-10 text-center md:text-left">
                  <div className="block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] xl:w-3/4 xl:items-center xl:justify-center xl:mx-auto">
                    <div className="flex flex-wrap items-center">
                      ...
                      <div className="w-full shrink-0 grow-0 basis-auto sm:w-6/12 xl:w-8/12">
                        <div className="mt-5 md:px-12">
                          <h2 className="mb-2 text-3xl font-bold text-red-700">Jonathan</h2>
                          <p className="mb-6 text-black text-lg sm:text-xl">
                            “Brian is good at pushing me outside of my comfort zone, but not too much that it
                            discourages me. And now, I feel as fit as I did 30 years ago.”
                          </p>
                        </div>
                      </div>
                    </div>
