...
export default function Hero2() {
  return (
    <div className="flex flex-col md:flex-row md:h-screen items-center">
      <div className="bg-red-500 text-white w-full md:w-1/2 p-5 md:h-full flex flex-col justify-center">
